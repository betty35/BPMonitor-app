...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        LocalChallengeDao.createTable(db, ifNotExists);
        MeasureDao.createTable(db, ifNotExists);
        RecordDao.createTable(db, ifNotExists);
        UserDao.createTable(db, ifNotExists);
        User_ScoreDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        LocalChallengeDao.dropTable(db, ifExists);
        MeasureDao.dropTable(db, ifExists);
        RecordDao.dropTable(db, ifExists);
        UserDao.dropTable(db, ifExists);
        User_ScoreDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(LocalChallengeDao.class);
        registerDaoClass(MeasureDao.class);
        registerDaoClass(RecordDao.class);
        registerDaoClass(UserDao.class);
        registerDaoClass(User_ScoreDao.class);
    }
